...
/**
 * BankInterfaceProperty Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class BankInterfaceProperty
{
    /**
     * Possible values of this enum
     */
    public const REDIRECT_APPROACH = 'REDIRECT_APPROACH';

    public const DECOUPLED_APPROACH = 'DECOUPLED_APPROACH';

    public const DETAILED_CONSENT = 'DETAILED_CONSENT';
    ...
    {
        return [
            self::REDIRECT_APPROACH,
            self::DECOUPLED_APPROACH,
            self::DETAILED_CONSENT
        ];
    }
}
