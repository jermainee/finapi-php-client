...
/**
 * EditTppCredentialParams Class Doc Comment
 *
 * @category Class
 ...
 */
class EditTppCredentialParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EditTppCredentialParams';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['tpp_client_id']) && (mb_strlen($this->container['tpp_client_id']) > 256)) {
            $invalidProperties[] = "invalid value for 'tpp_client_id', the character length must be smaller than or equal to 256.";
        }

        if (!is_null($this->container['tpp_client_id']) && (mb_strlen($this->container['tpp_client_id']) < 1)) {
            $invalidProperties[] = "invalid value for 'tpp_client_id', the character length must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['tpp_client_secret']) && (mb_strlen($this->container['tpp_client_secret']) > 256)) {
            $invalidProperties[] = "invalid value for 'tpp_client_secret', the character length must be smaller than or equal to 256.";
        }

        if (!is_null($this->container['tpp_client_secret']) && (mb_strlen($this->container['tpp_client_secret']) < 1)) {
            $invalidProperties[] = "invalid value for 'tpp_client_secret', the character length must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['tpp_api_key']) && (mb_strlen($this->container['tpp_api_key']) > 256)) {
            $invalidProperties[] = "invalid value for 'tpp_api_key', the character length must be smaller than or equal to 256.";
        }

        if (!is_null($this->container['tpp_api_key']) && (mb_strlen($this->container['tpp_api_key']) < 1)) {
            $invalidProperties[] = "invalid value for 'tpp_api_key', the character length must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['tpp_name']) && (mb_strlen($this->container['tpp_name']) > 256)) {
            $invalidProperties[] = "invalid value for 'tpp_name', the character length must be smaller than or equal to 256.";
        }

        if (!is_null($this->container['tpp_name']) && (mb_strlen($this->container['tpp_name']) < 1)) {
            $invalidProperties[] = "invalid value for 'tpp_name', the character length must be bigger than or equal to 1.";
        }
     ...
     *
     * @param int|null $tpp_authentication_group_id The TPP Authentication Group Id for which the credentials can be used
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label Label for credentials
     *
     * @return self
     */
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) > 256)) {
            throw new \InvalidArgumentException('invalid length for $label when calling EditTppCredentialParams., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($label) < 1)) {
            throw new \InvalidArgumentException('invalid length for $label when calling EditTppCredentialParams., must be bigger than or equal to 1.');
        }
    ...
    public function setTppClientId($tpp_client_id)
    {
        ...
        if ((mb_strlen($tpp_client_id) > 256)) {
            throw new \InvalidArgumentException('invalid length for $tpp_client_id when calling EditTppCredentialParams., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($tpp_client_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tpp_client_id when calling EditTppCredentialParams., must be bigger than or equal to 1.');
        }
    ...
    public function setTppClientSecret($tpp_client_secret)
    {
        ...
        if ((mb_strlen($tpp_client_secret) > 256)) {
            throw new \InvalidArgumentException('invalid length for $tpp_client_secret when calling EditTppCredentialParams., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($tpp_client_secret) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tpp_client_secret when calling EditTppCredentialParams., must be bigger than or equal to 1.');
        }
    ...
    public function setTppApiKey($tpp_api_key)
    {
        ...
        if ((mb_strlen($tpp_api_key) > 256)) {
            throw new \InvalidArgumentException('invalid length for $tpp_api_key when calling EditTppCredentialParams., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($tpp_api_key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tpp_api_key when calling EditTppCredentialParams., must be bigger than or equal to 1.');
        }
    ...
    public function setTppName($tpp_name)
    {
        ...
        if ((mb_strlen($tpp_name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $tpp_name when calling EditTppCredentialParams., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($tpp_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tpp_name when calling EditTppCredentialParams., must be bigger than or equal to 1.');
        }
