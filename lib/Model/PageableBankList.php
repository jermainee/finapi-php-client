...
/**
 * PageableBankList Class Doc Comment
 *
 * @category Class
 ...
 */
class PageableBankList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PageableBankList';
    ...
    */
     ...
     * Sets banks
     *
     * @param \OpenAPI\Client\Model\Bank[] $banks Banks<br/> <strong>Type:</strong> Bank
     *
     * @return self
     */
