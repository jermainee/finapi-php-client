...
/**
 * PageableStandingOrderResources Class Doc Comment
 *
 * @category Class
 ...
 */
class PageableStandingOrderResources implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PageableStandingOrderResources';
    ...
    protected static $openAPITypes = [
        'standing_orders' => '\OpenAPI\Client\Model\StandingOrder[]',
    ...
    protected static $setters = [
        'standing_orders' => 'setStandingOrders',
        'paging' => 'setPaging'
    ];
    ...
    protected static $getters = [
        'standing_orders' => 'getStandingOrders',
        'paging' => 'getPaging'
    ];
    ...
    {
        $this->setIfExists('standing_orders', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['standing_orders'] === null) {
            $invalidProperties[] = "'standing_orders' can't be null";
        }
    ...
    /**
     * Gets standing_orders
     *
     * @return \OpenAPI\Client\Model\StandingOrder[]
     */
    public function getStandingOrders()
    {
        return $this->container['standing_orders'];
    }

    /**
     * Sets standing_orders
     *
     * @param \OpenAPI\Client\Model\StandingOrder[] $standing_orders List of standing orders<br/> <strong>Type:</strong> StandingOrder
     *
     * @return self
     */
    public function setStandingOrders($standing_orders)
    {
        if (is_null($standing_orders)) {
            throw new \InvalidArgumentException('non-nullable standing_orders cannot be null');
        }
        $this->container['standing_orders'] = $standing_orders;
