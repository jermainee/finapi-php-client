...
class PendingTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'original_currency' => '\OpenAPI\Client\Model\Currency',
        'fee_amount' => 'float',
        'fee_currency' => '\OpenAPI\Client\Model\Currency',
        'different_debtor' => 'string',
        'different_creditor' => 'string',
        'paypal_data' => '\OpenAPI\Client\Model\PendingTransactionPaypalData',
        'certis_data' => '\OpenAPI\Client\Model\PendingTransactionCertisData'
    ];
    ...
    */
     ...
     * Sets value_date
     *
     * @param \DateTime $value_date <strong>Format:</strong> 'YYYY-MM-DD'<br/>Value date.<br/><br/><strong>NOTE:</strong> In case the bank does not deliver any date information for the transaction, finAPI will use the current date (i.e. date of import).
     *
     * @return self
     */
    ...
    public function setBankTransactionCodeDescription($bank_transaction_code_description)
    {
        ...
        if ((mb_strlen($bank_transaction_code_description) > 256)) {
            throw new \InvalidArgumentException('invalid length for $bank_transaction_code_description when calling PendingTransaction., must be smaller than or equal to 256.');
        }
     ...
     *
     * @param \OpenAPI\Client\Model\Currency|null $original_currency original_currency
     *
     * @return self
     */
     ...
     * Sets fee_currency
     *
     * @param \OpenAPI\Client\Model\Currency|null $fee_currency fee_currency
     *
     * @return self
     */
     ...
     * Gets paypal_data
     *
     * @return \OpenAPI\Client\Model\PendingTransactionPaypalData|null
     */
     ...
     * Sets paypal_data
     *
     * @param \OpenAPI\Client\Model\PendingTransactionPaypalData|null $paypal_data paypal_data
     *
     * @return self
     */
     ...
     * Gets certis_data
     *
     * @return \OpenAPI\Client\Model\PendingTransactionCertisData|null
     */
     ...
     * Sets certis_data
     *
     * @param \OpenAPI\Client\Model\PendingTransactionCertisData|null $certis_data certis_data
     *
     * @return self
     */
