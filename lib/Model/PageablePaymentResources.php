...
/**
 * PageablePaymentResources Class Doc Comment
 *
 * @category Class
 ...
 */
class PageablePaymentResources implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PageablePaymentResources';
    ...
    */
     ...
     * Sets payments
     *
     * @param \OpenAPI\Client\Model\Payment[] $payments List of received account payments<br/> <strong>Type:</strong> Payment
     *
     * @return self
     */
