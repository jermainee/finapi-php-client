...
class Payment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Model\PaymentType
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Model\PaymentType $type type
     *
     * @return self
     */
     ...
     *
     * @param bool|null $instant_payment Whether the order was submitted to the bank as an instant SEPA order.
     *
     * @return self
     */
