 ...
 */
class MockBankConnectionUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MockBankConnectionUpdate';
    ...
    protected static $openAPITypes = [
        ...
        'mock_accounts_data' => '\OpenAPI\Client\Model\MockAccountData[]'
    ];
    ...
    protected static array $openAPINullables = [
		...
		'simulate_bank_login_error' => false,
		'mock_accounts_data' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('simulate_bank_login_error', $data ?? [], false);
        $this->setIfExists('mock_accounts_data', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param bool|null $simulate_bank_login_error Whether to simulate the case that the update fails due to incorrect banking credentials. Note that there is no real communication to any bank server involved, so you won't lock your accounts when enabling this flag. Default value is 'false'.
     *
     * @return self
     */
    public function setSimulateBankLoginError($simulate_bank_login_error)
    {
        if (is_null($simulate_bank_login_error)) {
            throw new \InvalidArgumentException('non-nullable simulate_bank_login_error cannot be null');
        }
     ...
     *
     * @return \OpenAPI\Client\Model\MockAccountData[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\MockAccountData[]|null $mock_accounts_data Mock accounts data. Note that for accounts that exist in a bank connection but that you do not specify in this list, the service will act like those accounts are not received by the bank servers. This means that any accounts that you do not specify here will be marked as deprecated. If you do not specify this list at all, all accounts in the bank connection will be marked as deprecated.<br/> <strong>Type:</strong> MockAccountData
     *
     * @return self
     */
    public function setMockAccountsData($mock_accounts_data)
    {
        if (is_null($mock_accounts_data)) {
            throw new \InvalidArgumentException('non-nullable mock_accounts_data cannot be null');
        }
