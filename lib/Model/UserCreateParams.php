...
class UserCreateParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_auto_update_enabled', $data ?? [], false);
    }
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id User's identifier. Only the following symbols are allowed: 0-9, A-Z, a-z, -, _, ., +, @. If not specified, then a unique random value will be generated.
     *
     * @return self
     */
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $id when calling UserCreateParams., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling UserCreateParams., must be bigger than or equal to 1.');
        }
     ...
     * Sets password
     *
     * @param string|null $password User's password. If not specified, then a unique random value will be generated.
     *
     * @return self
     */
    public function setPassword($password)
    {
        ...
        if ((mb_strlen($password) > 128)) {
            throw new \InvalidArgumentException('invalid length for $password when calling UserCreateParams., must be smaller than or equal to 128.');
        }
        if ((mb_strlen($password) < 6)) {
            throw new \InvalidArgumentException('invalid length for $password when calling UserCreateParams., must be bigger than or equal to 6.');
        }
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 320)) {
            throw new \InvalidArgumentException('invalid length for $email when calling UserCreateParams., must be smaller than or equal to 320.');
        }
        if ((mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling UserCreateParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/[A-Za-z0-9¡-ʯ &\\(\\)\\{\\}\\[\\]\\.:,;\\?!\\+\\-_\\$@#~`\\^€]*/", $email))) {
    ...
    public function setPhone($phone)
    {
        ...
        if ((mb_strlen($phone) > 50)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling UserCreateParams., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($phone) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling UserCreateParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/[A-Za-z0-9¡-ʯ &\\(\\)\\{\\}\\[\\]\\.:,;\\?!\\+\\-_\\$@#~`\\^€]*/", $phone))) {
    ...
    {
        if (is_null($is_auto_update_enabled)) {
            throw new \InvalidArgumentException('non-nullable is_auto_update_enabled cannot be null');
        }
