 ...
 */
class UserIdentifiersList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserIdentifiersList';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('non_deleted_users', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($non_deleted_users)) {
            throw new \InvalidArgumentException('non-nullable non_deleted_users cannot be null');
        }
