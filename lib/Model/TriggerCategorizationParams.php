...
/**
 * TriggerCategorizationParams Class Doc Comment
 *
 * @category Class
 ...
 */
class TriggerCategorizationParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TriggerCategorizationParams';
    ...
    protected static $setters = [
        'bank_connection_ids' => 'setBankConnectionIds'
    ];
    ...
    protected static $getters = [
        'bank_connection_ids' => 'getBankConnectionIds'
    ];
    ...
    {
        $this->setIfExists('bank_connection_ids', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets bank_connection_ids
     *
     * @return int[]|null
     */
    public function getBankConnectionIds()
    {
        return $this->container['bank_connection_ids'];
    }

    /**
     * Sets bank_connection_ids
     *
     * @param int[]|null $bank_connection_ids List of identifiers of the bank connections that you want to trigger categorization for. Leaving the list unset or empty will trigger categorization for all of the user's bank connections. Please note that if there are no bank connections, then the service will return with HTTP code 422.
     *
     * @return self
     */
    public function setBankConnectionIds($bank_connection_ids)
    {
        if (is_null($bank_connection_ids)) {
            throw new \InvalidArgumentException('non-nullable bank_connection_ids cannot be null');
        }
        $this->container['bank_connection_ids'] = $bank_connection_ids;
