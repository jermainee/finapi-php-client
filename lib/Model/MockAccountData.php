 ...
 */
class MockAccountData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MockAccountData';
    ...
    protected static $openAPITypes = [
        ...
        'new_transactions' => '\OpenAPI\Client\Model\NewTransaction[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('new_transactions', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\NewTransaction[]|null
     */
