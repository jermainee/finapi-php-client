 ...
 */
class DailyBalance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DailyBalance';
    ...
    protected static $openAPITypes = [
        ...
        'income' => 'float',
        'spending' => 'float',
        'internal_adjusting_entries' => 'float',
        'transactions' => 'int[]'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'income' => null,
        'spending' => null,
        'internal_adjusting_entries' => null,
        'transactions' => 'int64'
    ];
    ...
    protected static array $openAPINullables = [
		...
		'income' => false,
		'spending' => false,
		'internal_adjusting_entries' => false,
		'transactions' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'income' => 'income',
        'spending' => 'spending',
        'internal_adjusting_entries' => 'internalAdjustingEntries',
    ...
    protected static $setters = [
        ...
        'internal_adjusting_entries' => 'setInternalAdjustingEntries',
    ...
    protected static $getters = [
        ...
        'internal_adjusting_entries' => 'getInternalAdjustingEntries',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('internal_adjusting_entries', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['internal_adjusting_entries'] === null) {
            $invalidProperties[] = "'internal_adjusting_entries' can't be null";
        }
     ...
     * Sets date
     *
     * @param \DateTime $date <strong>Format:</strong> 'YYYY-MM-DD'<br/>Date.
     *
     * @return self
     */
     ...
     * Sets balance
     *
     * @param float $balance Calculated balance at the end of day, across all regarded accounts. Note that the balance may not always add up to the income/spending of the day. This happens when a bank reports a balance that includes transactions which the bank didn't (yet) deliver. In any case, it is recommended to rely on the balance rather than on calculations based on the income/spending.
     *
     * @return self
     */
     ...
     * Sets income
     *
     * @param float $income The sum of income of the given day, based on the 'transactions', across all regarded accounts.
     *
     * @return self
     */
     ...
     * Sets spending
     *
     * @param float $spending The sum of spending of the given day, based on the 'transactions', across all regarded accounts. Note that this is an absolute (i.e. positive) value.
     *
     * @return self
     */
