 ...
 */
class LoginCredential implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoginCredential';
    ...
    */
     ...
     * Sets label
     *
     * @param string $label The login field label, as defined by the respective bank interface.
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string $value The value for the login field
     *
     * @return self
     */
