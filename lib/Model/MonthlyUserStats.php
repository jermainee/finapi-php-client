 ...
 */
class MonthlyUserStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MonthlyUserStats';
    ...
    protected static array $openAPINullables = [
        'month' => false,
		'min_bank_connection_count' => false,
		'max_bank_connection_count' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('min_bank_connection_count', $data ?? [], null);
        $this->setIfExists('max_bank_connection_count', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($min_bank_connection_count)) {
            throw new \InvalidArgumentException('non-nullable min_bank_connection_count cannot be null');
        }
    ...
    {
        if (is_null($max_bank_connection_count)) {
            throw new \InvalidArgumentException('non-nullable max_bank_connection_count cannot be null');
        }
