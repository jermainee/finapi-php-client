...
class NotificationRuleParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const TRIGGER_EVENT_NEW_ACCOUNT_BALANCE = 'NEW_ACCOUNT_BALANCE';
    public const TRIGGER_EVENT_NEW_TRANSACTIONS = 'NEW_TRANSACTIONS';
    public const TRIGGER_EVENT_BANK_LOGIN_ERROR = 'BANK_LOGIN_ERROR';
    public const TRIGGER_EVENT_FOREIGN_MONEY_TRANSFER = 'FOREIGN_MONEY_TRANSFER';
    public const TRIGGER_EVENT_LOW_ACCOUNT_BALANCE = 'LOW_ACCOUNT_BALANCE';
    public const TRIGGER_EVENT_HIGH_TRANSACTION_AMOUNT = 'HIGH_TRANSACTION_AMOUNT';
    public const TRIGGER_EVENT_CATEGORY_CASH_FLOW = 'CATEGORY_CASH_FLOW';
    public const TRIGGER_EVENT_NEW_TERMS_AND_CONDITIONS = 'NEW_TERMS_AND_CONDITIONS';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['trigger_event']) > 32)) {
            $invalidProperties[] = "invalid value for 'trigger_event', the character length must be smaller than or equal to 32.";
        }

        if ((mb_strlen($this->container['trigger_event']) < 0)) {
            $invalidProperties[] = "invalid value for 'trigger_event', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['callback_handle']) && (mb_strlen($this->container['callback_handle']) > 512)) {
            $invalidProperties[] = "invalid value for 'callback_handle', the character length must be smaller than or equal to 512.";
        }

        if (!is_null($this->container['callback_handle']) && (mb_strlen($this->container['callback_handle']) < 1)) {
            $invalidProperties[] = "invalid value for 'callback_handle', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setTriggerEvent($trigger_event)
    {
        ...
        if ((mb_strlen($trigger_event) > 32)) {
            throw new \InvalidArgumentException('invalid length for $trigger_event when calling NotificationRuleParams., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($trigger_event) < 0)) {
            throw new \InvalidArgumentException('invalid length for $trigger_event when calling NotificationRuleParams., must be bigger than or equal to 0.');
        }
     ...
     * Sets params
     *
     * @param array<string,string>|null $params Additional parameters that are specific to the chosen trigger event type. The specifics of the different trigger events are documented <a href='https://documentation.finapi.io/access/Push-Notifications-(Web-Hooks).2766405696.html' target='_blank'>here</a>.
     *
     * @return self
     */
     ...
     *
     * @param string|null $callback_handle An arbitrary string that finAPI will include into the notifications that it sends based on this rule and that you can use to identify the notification in your application. For instance, you could include the identifier of the user that you create this rule for.<br/><br/>Note that for this parameter, you can pass the symbols '/', '=', '%' and '\"' in addition to the symbols that are generally allowed in finAPI (see <a href='https://documentation.finapi.io/access/Allowed-Characters.2764767279.html' target='_blank'>Allowed Characters</a>). This was done to enable you to set Base64 encoded strings and JSON structures for the callback handle.
     *
     * @return self
     */
    public function setCallbackHandle($callback_handle)
    {
        ...
        if ((mb_strlen($callback_handle) > 512)) {
            throw new \InvalidArgumentException('invalid length for $callback_handle when calling NotificationRuleParams., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($callback_handle) < 1)) {
            throw new \InvalidArgumentException('invalid length for $callback_handle when calling NotificationRuleParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/[A-Za-z0-9¡-ʯ &\\(\\)\\{\\}\\[\\]\\.:,;\\?!\\+\\-_\\$@#~`\\^€\/=%\"]*/", $callback_handle))) {
