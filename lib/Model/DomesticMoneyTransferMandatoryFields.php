...
/**
 * DomesticMoneyTransferMandatoryFields Class Doc Comment
 *
 * @category Class
 ...
 */
class DomesticMoneyTransferMandatoryFields implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DomesticMoneyTransferMandatoryFields';
    ...
    */
     ...
     * Sets end_to_end_id
     *
     * @param bool|null $end_to_end_id Indicates whether the endToEndId must be provided for domestic money transfers.
     *
     * @return self
     */
