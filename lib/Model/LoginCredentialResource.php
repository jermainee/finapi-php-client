...
/**
 * LoginCredentialResource Class Doc Comment
 *
 * @category Class
 ...
 */
class LoginCredentialResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoginCredentialResource';
    ...
    */
     ...
     * Sets label
     *
     * @param string $label Label for this login credential, as we suggest to show it to the user.
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string|null $value Stored value for this login credential. Please NOTE:<br/>If your client has no license for processing banking credentials, or if this field contains a value that requires password protection (e.g. PIN), then this field will always be 'XXXXX'.
     *
     * @return self
     */
