...
class AccessToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets access_token
     *
     * @param string $access_token Access token. Token has a length of up to 8192 characters. Currently tokens with a maximum length of 128 characters are returned, but longer token types may be used in the future.
     *
     * @return self
     */
     ...
     * Sets refresh_token
     *
     * @param string|null $refresh_token Refresh token. Only set in case of grant_type='password'. Token has a length of up to 8192 characters. Currently tokens with a maximum length of 128 characters are returned, but longer token types may be used in the future.
     *
     * @return self
     */
