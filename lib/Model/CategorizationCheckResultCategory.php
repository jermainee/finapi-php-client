...
/**
 * CategorizationCheckResultCategory Class Doc Comment
 *
 * @category Class
 * @description A category. The determined transaction category for the given transactionId. This can be null, if the categorization algorithm fails to find a matching rule.&lt;br/&gt; &lt;strong&gt;Type:&lt;/strong&gt; Category
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CategorizationCheckResultCategory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CategorizationCheckResult_category';
    ...
    */
     ...
     * Sets parent_id
     *
     * @param int|null $parent_id Identifier of the parent category (if a parent category exists)
     *
     * @return self
     */
     ...
     * Sets parent_name
     *
     * @param string|null $parent_name Name of the parent category (if a parent category exists)
     *
     * @return self
     */
     ...
     * Sets children
     *
     * @param int[]|null $children List of sub-categories identifiers (if any exist)
     *
     * @return self
     */
