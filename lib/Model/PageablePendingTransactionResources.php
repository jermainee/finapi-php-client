...
class PageablePendingTransactionResources implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'pending_transactions' => '\OpenAPI\Client\Model\PendingTransaction[]',
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\PendingTransaction[]
     */
     ...
     *
     * @param \OpenAPI\Client\Model\PendingTransaction[] $pending_transactions Array of pending transactions (for the requested page)<br/> <strong>Type:</strong> PendingTransaction
     *
     * @return self
     */
