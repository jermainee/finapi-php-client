 ...
 *
 * @category Class
 * @description Logo of the bank. If available, the logo will be rendered on our Web Form 2.0 where applicable. Customers that do not use our Web Form can use this data to render the bank&#39;s logo within their application&#39;s front end.&lt;br/&gt; &lt;strong&gt;Type:&lt;/strong&gt; BankImage
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class BankLogo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Bank_logo';
