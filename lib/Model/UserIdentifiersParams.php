...
/**
 * UserIdentifiersParams Class Doc Comment
 *
 * @category Class
 ...
 */
class UserIdentifiersParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserIdentifiersParams';
    ...
    */
     ...
     * Sets user_ids
     *
     * @param string[] $user_ids List of user identifiers
     *
     * @return self
     */
