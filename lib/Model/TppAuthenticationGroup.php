...
/**
 * TppAuthenticationGroup Class Doc Comment
 *
 * @category Class
 * @description TPP authentication group represents certain bank group and contains a set of TPP credentials which can be used with bank interface connected to this group.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class TppAuthenticationGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TppAuthenticationGroup';
    ...
    */
     ...
     * Sets id
     *
     * @param int $id TPP Authentication Group ID
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name TPP Authentication Group name
     *
     * @return self
     */
