...
class User implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_auto_update_enabled'] === null) {
            $invalidProperties[] = "'is_auto_update_enabled' can't be null";
        }
     ...
     * Sets password
     *
     * @param string $password User's password. Please note that some services may return a distorted password (always 'XXXXX'). See the documentation of individual services to find out whether the password is returned as plain text or as 'XXXXX'.
     *
     * @return self
     */
