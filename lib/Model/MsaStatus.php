...
class MsaStatus
{
     ...
     */
    public const CHALLENGE_RESPONSE_REQUIRED = 'CHALLENGE_RESPONSE_REQUIRED';

    public const TWO_STEP_PROCEDURE_REQUIRED = 'TWO_STEP_PROCEDURE_REQUIRED';

    public const REDIRECT_REQUIRED = 'REDIRECT_REQUIRED';

    public const DECOUPLED_AUTH_REQUIRED = 'DECOUPLED_AUTH_REQUIRED';

    public const DECOUPLED_AUTH_IN_PROGRESS = 'DECOUPLED_AUTH_IN_PROGRESS';
    ...
    {
        return [
            self::CHALLENGE_RESPONSE_REQUIRED,
            self::TWO_STEP_PROCEDURE_REQUIRED,
            self::REDIRECT_REQUIRED,
            self::DECOUPLED_AUTH_REQUIRED,
            self::DECOUPLED_AUTH_IN_PROGRESS
        ];
    }
}
