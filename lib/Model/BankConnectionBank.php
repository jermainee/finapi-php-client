 ...
 *
 * @category Class
 * @description Bank that this connection belongs to&lt;br/&gt; &lt;strong&gt;Type:&lt;/strong&gt; Bank
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class BankConnectionBank implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'is_test_bank' => 'bool',
        'popularity' => 'int',
        'interfaces' => '\OpenAPI\Client\Model\BankInterface[]',
        'bank_group' => '\OpenAPI\Client\Model\BankBankGroup',
        'is_beta' => 'bool',
        'logo' => '\OpenAPI\Client\Model\BankLogo',
        'icon' => '\OpenAPI\Client\Model\BankIcon'
    ];
    ...
    */
     ...
     * Sets blz
     *
     * @param string $blz BLZ of bank. Please do NOT use this field to identify a bank, since there can be multiple banks with the same BLZ. If you need to identify a bank, refer to the <code>id</code> field instead.
     *
     * @return self
     */
     ...
     * Gets interfaces
     *
     * @return \OpenAPI\Client\Model\BankInterface[]
     */
     ...
     * Sets interfaces
     *
     * @param \OpenAPI\Client\Model\BankInterface[] $interfaces Set of interfaces that exist for the bank.<br/><br/>Note:<br/>&bull; If the set is empty, then the bank is not supported.<br/>&bull; Even if an interface is listed, it might not be usable at the moment. Please always refer to the fields 'BankInterface.isAisSupported' / 'BankInterface.isPisSupported' before you attempt to use an interface.<br/>&bull; The WEB_SCRAPER interface might be disabled for your client (see GET /clientConfiguration). When this is the case, then finAPI will not use the web scraper for data download, and if the web scraper is the only supported interface of this bank, then finAPI will not allow to download any data for this bank at all (for details, see POST /bankConnections/import and POST /bankConnections/update). Also, you will not be able to do payments via the WEB_SCRAPER interface, if web scraping is disabled for your client.<br/> <strong>Type:</strong> BankInterface
     *
     * @return self
     */
     ...
     * Gets bank_group
     *
     * @return \OpenAPI\Client\Model\BankBankGroup|null
     */
     ...
     * Sets bank_group
     *
     * @param \OpenAPI\Client\Model\BankBankGroup|null $bank_group bank_group
     *
     * @return self
     */
     ...
     * Gets logo
     *
     * @return \OpenAPI\Client\Model\BankLogo|null
     */
     ...
     * Sets logo
     *
     * @param \OpenAPI\Client\Model\BankLogo|null $logo logo
     *
     * @return self
     */
     ...
     * Gets icon
     *
     * @return \OpenAPI\Client\Model\BankIcon|null
     */
     ...
     * Sets icon
     *
     * @param \OpenAPI\Client\Model\BankIcon|null $icon icon
     *
     * @return self
     */
