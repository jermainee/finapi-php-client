...
class ErrorMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'errors' => '\OpenAPI\Client\Model\ErrorDetails[]',
        'date' => '\DateTime',
        'request_id' => 'string',
        'endpoint' => 'string',
        'auth_context' => 'string',
    ...
    */
     ...
     * Gets errors
     *
     * @return \OpenAPI\Client\Model\ErrorDetails[]
     */
     ...
     * Sets errors
     *
     * @param \OpenAPI\Client\Model\ErrorDetails[] $errors List of errors<br/> <strong>Type:</strong> ErrorDetails
     *
     * @return self
     */
     ...
     * Sets date
     *
     * @param \DateTime $date <strong>Format:</strong> 'YYYY-MM-DD'T'HH:MM:SS.SSSXXX' (RFC 3339, section 5.6)<br/>Server date of when the error(s) occurred
     *
     * @return self
     */
     ...
     * Sets request_id
     *
     * @param string $request_id ID of the request that caused this error. This is either what you have passed for the header 'X-Request-Id', or an auto-generated ID in case you didn't pass any value for that header.<br/><br/>
     *
     * @return self
     */
    ...
    public function setAuthContext($auth_context)
    {
        if (is_null($auth_context)) {
            throw new \InvalidArgumentException('non-nullable auth_context cannot be null');
        }
     ...
     * Sets bank
     *
     * @param string|null $bank BLZ and name (in format \"<BLZ> - <name>\") of a bank that was used for the original request
     *
     * @return self
     */
