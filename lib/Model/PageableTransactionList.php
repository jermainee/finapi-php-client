 ...
 *
 * @category Class
 * @description Container for a page of transactions, with data about the total count of transactions and their balance with paging information
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PageableTransactionList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PageableTransactionList';
    ...
    */
     ...
     * Sets transactions
     *
     * @param \OpenAPI\Client\Model\Transaction[] $transactions Array of transactions (for the requested page)<br/> <strong>Type:</strong> Transaction
     *
     * @return self
     */
