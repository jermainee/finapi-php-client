 ...
 */
class PasswordChangingResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PasswordChangingResource';
    ...
    */
     ...
     * Sets user_email
     *
     * @param string|null $user_email User's email, encrypted. Decrypt with your data decryption key. If the user has no email set, then this field will be null.
     *
     * @return self
     */
     ...
     *
     * @param string $password_change_token Encrypted password change token. Decrypt this token with your data decryption key, and pass the decrypted token to the /users/executePasswordChange service to set a new password for the user.
     *
     * @return self
     */
