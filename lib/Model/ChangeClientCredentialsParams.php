 ...
 */
class ChangeClientCredentialsParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChangeClientCredentialsParams';
    ...
    protected static array $openAPINullables = [
        'client_id' => false,
		'old_client_secret' => false,
		'new_client_secret' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('old_client_secret', $data ?? [], null);
        $this->setIfExists('new_client_secret', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['client_id']) > 45)) {
            $invalidProperties[] = "invalid value for 'client_id', the character length must be smaller than or equal to 45.";
        }
        ...
        if ((mb_strlen($this->container['old_client_secret']) > 36)) {
            $invalidProperties[] = "invalid value for 'old_client_secret', the character length must be smaller than or equal to 36.";
        }

        if ((mb_strlen($this->container['old_client_secret']) < 36)) {
            $invalidProperties[] = "invalid value for 'old_client_secret', the character length must be bigger than or equal to 36.";
        }

        if ($this->container['new_client_secret'] === null) {
            $invalidProperties[] = "'new_client_secret' can't be null";
        }
        if ((mb_strlen($this->container['new_client_secret']) > 36)) {
            $invalidProperties[] = "invalid value for 'new_client_secret', the character length must be smaller than or equal to 36.";
        }

        if ((mb_strlen($this->container['new_client_secret']) < 36)) {
            $invalidProperties[] = "invalid value for 'new_client_secret', the character length must be bigger than or equal to 36.";
        }
    ...
    public function setClientId($client_id)
    {
        ...
        if ((mb_strlen($client_id) > 45)) {
            throw new \InvalidArgumentException('invalid length for $client_id when calling ChangeClientCredentialsParams., must be smaller than or equal to 45.');
        }
        if ((mb_strlen($client_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $client_id when calling ChangeClientCredentialsParams., must be bigger than or equal to 1.');
        }
    ...
    {
        if (is_null($old_client_secret)) {
            throw new \InvalidArgumentException('non-nullable old_client_secret cannot be null');
        }
        if ((mb_strlen($old_client_secret) > 36)) {
            throw new \InvalidArgumentException('invalid length for $old_client_secret when calling ChangeClientCredentialsParams., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($old_client_secret) < 36)) {
            throw new \InvalidArgumentException('invalid length for $old_client_secret when calling ChangeClientCredentialsParams., must be bigger than or equal to 36.');
        }
     ...
     *
     * @param string $new_client_secret New client_secret. Allowed symbols: Digits (0 through 9), lower-case and upper-case letters (A through Z), and the dash symbol (\"-\").
     *
     * @return self
     */
    public function setNewClientSecret($new_client_secret)
    {
        if (is_null($new_client_secret)) {
            throw new \InvalidArgumentException('non-nullable new_client_secret cannot be null');
        }
        if ((mb_strlen($new_client_secret) > 36)) {
            throw new \InvalidArgumentException('invalid length for $new_client_secret when calling ChangeClientCredentialsParams., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($new_client_secret) < 36)) {
            throw new \InvalidArgumentException('invalid length for $new_client_secret when calling ChangeClientCredentialsParams., must be bigger than or equal to 36.');
        }
