 ...
 */
class TwoStepProcedure implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TwoStepProcedure';
    ...
    protected static array $openAPINullables = [
		...
		'procedure_challenge_type' => false,
		'implicit_execute' => false
    ];
    ...
    {
        $this->setIfExists('procedure_id', $data ?? [], null);
        $this->setIfExists('procedure_name', $data ?? [], null);
        $this->setIfExists('procedure_challenge_type', $data ?? [], null);
        $this->setIfExists('implicit_execute', $data ?? [], null);
    }
    ...
    */
    ...
    public function setProcedureId($procedure_id)
    {
        if (is_null($procedure_id)) {
            throw new \InvalidArgumentException('non-nullable procedure_id cannot be null');
        }
    ...
    {
        if (is_null($procedure_name)) {
            throw new \InvalidArgumentException('non-nullable procedure_name cannot be null');
        }
    ...
    {
        if (is_null($implicit_execute)) {
            throw new \InvalidArgumentException('non-nullable implicit_execute cannot be null');
        }
