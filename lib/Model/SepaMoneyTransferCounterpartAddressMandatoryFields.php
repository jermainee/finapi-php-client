...
/**
 * SepaMoneyTransferCounterpartAddressMandatoryFields Class Doc Comment
 *
 * @category Class
 * @description Lists the counterparty (recipient) address fields required by the bank for SEPA money transfers.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SepaMoneyTransferCounterpartAddressMandatoryFields implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SepaMoneyTransferCounterpartAddressMandatoryFields';
    ...
    */
     ...
     * Sets street
     *
     * @param bool|null $street Indicates whether the street must be provided for SEPA money transfers.
     *
     * @return self
     */
     ...
     * Sets house_number
     *
     * @param bool|null $house_number Indicates whether the house number must be provided for SEPA money transfers.
     *
     * @return self
     */
     ...
     * Sets post_code
     *
     * @param bool|null $post_code Indicates whether the post code must be provided for SEPA money transfers.
     *
     * @return self
     */
     ...
     * Sets city
     *
     * @param bool|null $city Indicates whether the city must be provided for SEPA money transfers.
     *
     * @return self
     */
     ...
     * Sets country
     *
     * @param bool|null $country Indicates whether the country must be provided for SEPA money transfers.
     *
     * @return self
     */
