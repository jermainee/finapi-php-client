 ...
 */
class TrainCategorizationTransactionData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TrainCategorizationTransactionData';
    ...
    */
    ...
    public function setPurpose($purpose)
    {
        ...
        if ((mb_strlen($purpose) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $purpose when calling TrainCategorizationTransactionData., must be smaller than or equal to 2000.');
        }
        if ((mb_strlen($purpose) < 1)) {
            throw new \InvalidArgumentException('invalid length for $purpose when calling TrainCategorizationTransactionData., must be bigger than or equal to 1.');
        }
    ...
    public function setCounterpart($counterpart)
    {
        ...
        if ((mb_strlen($counterpart) > 80)) {
            throw new \InvalidArgumentException('invalid length for $counterpart when calling TrainCategorizationTransactionData., must be smaller than or equal to 80.');
        }
        if ((mb_strlen($counterpart) < 1)) {
            throw new \InvalidArgumentException('invalid length for $counterpart when calling TrainCategorizationTransactionData., must be bigger than or equal to 1.');
        }
    ...
    public function setCounterpartAccountNumber($counterpart_account_number)
    {
        ...
        if ((mb_strlen($counterpart_account_number) > 34)) {
            throw new \InvalidArgumentException('invalid length for $counterpart_account_number when calling TrainCategorizationTransactionData., must be smaller than or equal to 34.');
        }
        if ((mb_strlen($counterpart_account_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $counterpart_account_number when calling TrainCategorizationTransactionData., must be bigger than or equal to 1.');
        }
     ...
     * Sets mc_code
     *
     * @param string|null $mc_code Merchant category code (for credit card transactions only). Default value: null. NOTE: This field is currently not regarded.
     *
     * @return self
     */
