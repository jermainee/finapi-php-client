...
/**
 * PageableSecurityList Class Doc Comment
 *
 * @category Class
 ...
 */
class PageableSecurityList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PageableSecurityList';
    ...
    {
        $this->setIfExists('securities', $data ?? [], null);
    ...
    */
     ...
     * Sets securities
     *
     * @param \OpenAPI\Client\Model\Security[] $securities List of securities<br/> <strong>Type:</strong> Security
     *
     * @return self
     */
    public function setSecurities($securities)
    {
        if (is_null($securities)) {
            throw new \InvalidArgumentException('non-nullable securities cannot be null');
        }
