...
class CashFlow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'category' => '\OpenAPI\Client\Model\CashFlowCategory',
        'income' => 'float',
        'spending' => 'float',
        'balance' => 'float',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('count_all_transactions', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets category
     *
     * @return \OpenAPI\Client\Model\CashFlowCategory|null
     */
     ...
     * Sets category
     *
     * @param \OpenAPI\Client\Model\CashFlowCategory|null $category category
     *
     * @return self
     */
    ...
    {
        if (is_null($count_all_transactions)) {
            throw new \InvalidArgumentException('non-nullable count_all_transactions cannot be null');
        }
