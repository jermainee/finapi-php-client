 ...
 */
class BankConnectionOwner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BankConnectionOwner';
    ...
    */
     ...
     * Sets date_of_birth
     *
     * @param \DateTime|null $date_of_birth <strong>Format:</strong> 'YYYY-MM-DD'<br/>Date of birth
     *
     * @return self
     */
     ...
     * Sets post_code
     *
     * @param string|null $post_code Post code
     *
     * @return self
     */
