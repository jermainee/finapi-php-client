...
/**
 * CategorizationCheckResult Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CategorizationCheckResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CategorizationCheckResult';
    ...
    protected static $openAPITypes = [
        ...
        'category' => '\OpenAPI\Client\Model\CategorizationCheckResultCategory'
    ];
    ...
    */
     ...
     * Sets transaction_id
     *
     * @param string $transaction_id The transaction identifier. The transactionId of the transaction that was passed to the service as input. This is not an actual ID of a stored transaction in finAPI, as the checkCategorization service doesn't store any data.
     *
     * @return self
     */
     ...
     * Gets category
     *
     * @return \OpenAPI\Client\Model\CategorizationCheckResultCategory|null
     */
     ...
     * Sets category
     *
     * @param \OpenAPI\Client\Model\CategorizationCheckResultCategory|null $category category
     *
     * @return self
     */
