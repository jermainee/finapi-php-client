 ...
 */
class CashFlowList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CashFlowList';
    ...
    protected static $openAPITypes = [
        'cash_flows' => '\OpenAPI\Client\Model\CashFlow[]',
        'total_income' => 'float',
    ...
    {
        $this->setIfExists('cash_flows', $data ?? [], null);
    ...
    */
     ...
     * Gets cash_flows
     *
     * @return \OpenAPI\Client\Model\CashFlow[]
     */
     ...
     * Sets cash_flows
     *
     * @param \OpenAPI\Client\Model\CashFlow[] $cash_flows Array of cash flows<br/> <strong>Type:</strong> CashFlow
     *
     * @return self
     */
    public function setCashFlows($cash_flows)
    {
        if (is_null($cash_flows)) {
            throw new \InvalidArgumentException('non-nullable cash_flows cannot be null');
        }
