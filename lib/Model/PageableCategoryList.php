...
/**
 * PageableCategoryList Class Doc Comment
 *
 * @category Class
 ...
 */
class PageableCategoryList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PageableCategoryList';
    ...
    */
     ...
     * Sets categories
     *
     * @param \OpenAPI\Client\Model\Category[] $categories Categories<br/> <strong>Type:</strong> Category
     *
     * @return self
     */
