 ...
 */
class BankInterfaceLoginField implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BankInterfaceLoginField';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_volatile', $data ?? [], null);
    ...
    */
     ...
     * Sets is_mandatory
     *
     * @param bool $is_mandatory Indicates whether this is a mandatory or optional login field. We recommend showing all login fields to the users (mandatory and optional).
     *
     * @return self
     */
