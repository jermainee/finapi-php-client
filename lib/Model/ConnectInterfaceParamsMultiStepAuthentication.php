...
/**
 * ConnectInterfaceParamsMultiStepAuthentication Class Doc Comment
 *
 * @category Class
 * @description Container for multi-step authentication data. Required when a previous service call initiated a multi-step authentication.&lt;br/&gt; &lt;strong&gt;Type:&lt;/strong&gt; MultiStepAuthenticationCallback
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ConnectInterfaceParamsMultiStepAuthentication implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConnectInterfaceParams_multiStepAuthentication';
    ...
    */
    ...
    public function setHash($hash)
    {
        ...
        if ((mb_strlen($hash) > 32)) {
            throw new \InvalidArgumentException('invalid length for $hash when calling ConnectInterfaceParamsMultiStepAuthentication., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($hash) < 1)) {
            throw new \InvalidArgumentException('invalid length for $hash when calling ConnectInterfaceParamsMultiStepAuthentication., must be bigger than or equal to 1.');
        }
    ...
    public function setChallengeResponse($challenge_response)
    {
        ...
        if ((mb_strlen($challenge_response) < 1)) {
            throw new \InvalidArgumentException('invalid length for $challenge_response when calling ConnectInterfaceParamsMultiStepAuthentication., must be bigger than or equal to 1.');
        }
    ...
    public function setTwoStepProcedureId($two_step_procedure_id)
    {
        ...
        if ((mb_strlen($two_step_procedure_id) > 512)) {
            throw new \InvalidArgumentException('invalid length for $two_step_procedure_id when calling ConnectInterfaceParamsMultiStepAuthentication., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($two_step_procedure_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $two_step_procedure_id when calling ConnectInterfaceParamsMultiStepAuthentication., must be bigger than or equal to 1.');
        }
    ...
    public function setRedirectCallback($redirect_callback)
    {
        ...
        if ((mb_strlen($redirect_callback) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $redirect_callback when calling ConnectInterfaceParamsMultiStepAuthentication., must be smaller than or equal to 2048.');
        }
        if ((mb_strlen($redirect_callback) < 1)) {
            throw new \InvalidArgumentException('invalid length for $redirect_callback when calling ConnectInterfaceParamsMultiStepAuthentication., must be bigger than or equal to 1.');
        }
