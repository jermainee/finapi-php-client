...
/**
 * SubmitStandingOrderParams Class Doc Comment
 *
 * @category Class
 ...
 */
class SubmitStandingOrderParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubmitStandingOrderParams';
    ...
    */
     ...
     *
     * @param int $standing_order_id Standing order identifier
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\LoginCredential[]|null $login_credentials Login credentials. May not be required when the credentials are stored in finAPI, or when the bank interface has no login credentials.<br/> <strong>Type:</strong> LoginCredential
     *
     * @return self
     */
    ...
    public function setRedirectUrl($redirect_url)
    {
        ...
        if ((mb_strlen($redirect_url) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $redirect_url when calling SubmitStandingOrderParams., must be smaller than or equal to 2048.');
        }
        if ((mb_strlen($redirect_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $redirect_url when calling SubmitStandingOrderParams., must be bigger than or equal to 1.');
        }
