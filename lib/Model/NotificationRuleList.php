...
/**
 * NotificationRuleList Class Doc Comment
 *
 * @category Class
 ...
 */
class NotificationRuleList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NotificationRuleList';
    ...
    protected static $openAPITypes = [
        'notification_rules' => '\OpenAPI\Client\Model\NotificationRule[]'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['notification_rules'] === null) {
            $invalidProperties[] = "'notification_rules' can't be null";
        }
     ...
     *
     * @return \OpenAPI\Client\Model\NotificationRule[]
     */
     ...
     *
     * @param \OpenAPI\Client\Model\NotificationRule[] $notification_rules List of notification rules<br/> <strong>Type:</strong> NotificationRule
     *
     * @return self
     */
