...
/**
 * SepaMoneyTransferMandatoryFields Class Doc Comment
 *
 * @category Class
 * @description Set of mandatory fields for SEPA money transfers via this interface. Note that fields that are always required (independent of the bank/interface) are not defined here.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SepaMoneyTransferMandatoryFields implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SepaMoneyTransferMandatoryFields';
    ...
    protected static $openAPITypes = [
        'purpose' => 'bool',
        'counterpart_name' => 'bool',
        'counterpart_bic' => 'bool',
        'counterpart_bank_name' => 'bool',
        'end_to_end_id' => 'bool',
        'counterpart_address' => '\OpenAPI\Client\Model\SepaMoneyTransferCounterpartAddressMandatoryFields'
    ];
    ...
    */
     ...
     * Sets purpose
     *
     * @param bool|null $purpose Indicates whether the purpose must be provided for SEPA money transfers.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $counterpart_name Indicates whether the counterpart name must be provided for SEPA money transfers.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $counterpart_bic Indicates whether the counterpart BIC must be provided for SEPA money transfers.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $counterpart_bank_name Indicates whether the counterpart bank name must be provided for SEPA money transfers.
     *
     * @return self
     */
     ...
     * Sets end_to_end_id
     *
     * @param bool|null $end_to_end_id Indicates whether the endToEndId must be provided for SEPA money transfers.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\SepaMoneyTransferCounterpartAddressMandatoryFields|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\SepaMoneyTransferCounterpartAddressMandatoryFields|null $counterpart_address counterpart_address
     *
     * @return self
     */
