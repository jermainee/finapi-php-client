...
class NotificationRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('include_details', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets params
     *
     * @param array<string,string> $params Additional parameters that are specific to the trigger event type. Please refer to the documentation for details.
     *
     * @return self
     */
     ...
     *
     * @param string|null $callback_handle The string that finAPI includes into the notifications that it sends based on this rule.
     *
     * @return self
     */
