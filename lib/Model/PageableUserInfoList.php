...
/**
 * PageableUserInfoList Class Doc Comment
 *
 * @category Class
 ...
 */
class PageableUserInfoList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PageableUserInfoList';
    ...
    protected static $openAPITypes = [
        'users' => '\OpenAPI\Client\Model\UserInfo[]',
    ...
    */
     ...
     * Sets users
     *
     * @param \OpenAPI\Client\Model\UserInfo[] $users List of users information<br/> <strong>Type:</strong> UserInfo
     *
     * @return self
     */
