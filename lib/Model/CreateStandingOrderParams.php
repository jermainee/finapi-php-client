    ...
    */
    ...
    public function setCounterpartName($counterpart_name)
    {
        ...
        if ((mb_strlen($counterpart_name) > 70)) {
            throw new \InvalidArgumentException('invalid length for $counterpart_name when calling CreateStandingOrderParams., must be smaller than or equal to 70.');
        }
        if ((mb_strlen($counterpart_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $counterpart_name when calling CreateStandingOrderParams., must be bigger than or equal to 1.');
        }
     ...
     * Sets amount
     *
     * @param float $amount The amount of the standing order. Must be a positive decimal number with at most two decimal places.<br/>Please refer to the <a href='https://documentation.finapi.io/payments/payment-data-validation' target='_blank'> Payment Data Validation documentation </a> for more details.
     *
     * @return self
     */
     ...
     * Sets purpose
     *
     * @param string|null $purpose The purpose of the standing order.<br/>Please refer to the <a href='https://documentation.finapi.io/payments/payment-data-validation' target='_blank'> Payment Data Validation documentation </a> for more details.
     *
     * @return self
     */
    public function setPurpose($purpose)
    {
        ...
        if ((mb_strlen($purpose) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $purpose when calling CreateStandingOrderParams., must be smaller than or equal to 2000.');
        }
        if ((mb_strlen($purpose) < 1)) {
            throw new \InvalidArgumentException('invalid length for $purpose when calling CreateStandingOrderParams., must be bigger than or equal to 1.');
        }
     ...
     * Sets end_to_end_id
     *
     * @param string|null $end_to_end_id End-To-End ID of the standing order.<br/>Please refer to the <a href='https://documentation.finapi.io/payments/payment-data-validation' target='_blank'> Payment Data Validation documentation </a> for more details.
     *
     * @return self
     */
    public function setEndToEndId($end_to_end_id)
    {
        ...
        if ((mb_strlen($end_to_end_id) > 35)) {
            throw new \InvalidArgumentException('invalid length for $end_to_end_id when calling CreateStandingOrderParams., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($end_to_end_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $end_to_end_id when calling CreateStandingOrderParams., must be bigger than or equal to 1.');
        }
     ...
     * Sets start_date
     *
     * @param \DateTime $start_date <strong>Format:</strong> 'YYYY-MM-DD'<br/>Start date of the standing order. Date must be in the future (at least tomorrow).
     *
     * @return self
     */
     ...
     * Sets end_date
     *
     * @param \DateTime|null $end_date <strong>Format:</strong> 'YYYY-MM-DD'<br/>Termination date of the standing order. If provided, it must be after the 'startDate'. If not provided, then the standing order will have no termination.
     *
     * @return self
     */
