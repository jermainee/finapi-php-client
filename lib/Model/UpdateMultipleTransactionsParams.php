 ...
 */
class UpdateMultipleTransactionsParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateMultipleTransactionsParams';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('train_categorization', $data ?? [], true);
    ...
    */
     ...
     * Sets is_new
     *
     * @param bool|null $is_new Whether this transactions should be flagged as 'new' or not. Any newly imported transaction will have this flag initially set to true. How you use this field is up to your interpretation. For example, you might want to set it to false once a user has clicked on/seen the transaction.
     *
     * @return self
     */
     ...
     * Sets label_ids
     *
     * @param int[]|null $label_ids Identifiers of labels to apply to the transaction. To clear transactions' labels, pass an empty array of identifiers: '[]'
     *
     * @return self
     */
     ...
     * Sets ids
     *
     * @param int[]|null $ids A comma-separated list of transaction identifiers. If specified, then only transactions whose identifier match any of the given identifiers will be regarded. The maximum number of identifiers is 100.
     *
     * @return self
     */
     ...
     * Sets account_ids
     *
     * @param int[]|null $account_ids A comma-separated list of account identifiers. If specified, then only transactions whose account's identifier is included in this list will be regarded.
     *
     * @return self
     */
