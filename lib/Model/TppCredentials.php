 ...
 */
class TppCredentials implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TppCredentials';
    ...
    */
     ...
     * Sets label
     *
     * @param string $label Label of tpp client credentials set.
     *
     * @return self
     */
     ...
     * Sets valid_until
     *
     * @param \DateTime|null $valid_until <strong>Format:</strong> 'YYYY-MM-DD'<br/>Valid until date.
     *
     * @return self
     */
