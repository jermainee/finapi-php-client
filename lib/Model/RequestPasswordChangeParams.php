...
/**
 * RequestPasswordChangeParams Class Doc Comment
 *
 * @category Class
 ...
 */
class RequestPasswordChangeParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequestPasswordChangeParams';
    ...
    */
    ...
    public function setUserId($user_id)
    {
        ...
        if ((mb_strlen($user_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $user_id when calling RequestPasswordChangeParams., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($user_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $user_id when calling RequestPasswordChangeParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/[a-zA-Z0-9\\-_\\.\\+@]*/", $user_id))) {
            throw new \InvalidArgumentException("invalid value for \$user_id when calling RequestPasswordChangeParams., must conform to the pattern /[a-zA-Z0-9\\-_\\.\\+@]*/.");
        }
