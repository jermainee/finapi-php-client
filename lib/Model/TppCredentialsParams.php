...
class TppCredentialsParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['tpp_client_id']) && (mb_strlen($this->container['tpp_client_id']) < 0)) {
            $invalidProperties[] = "invalid value for 'tpp_client_id', the character length must be bigger than or equal to 0.";
        }
        ...
        if (!is_null($this->container['tpp_client_secret']) && (mb_strlen($this->container['tpp_client_secret']) < 0)) {
            $invalidProperties[] = "invalid value for 'tpp_client_secret', the character length must be bigger than or equal to 0.";
        }
        ...
        if (!is_null($this->container['tpp_api_key']) && (mb_strlen($this->container['tpp_api_key']) < 0)) {
            $invalidProperties[] = "invalid value for 'tpp_api_key', the character length must be bigger than or equal to 0.";
        }
        ...
        if (!is_null($this->container['tpp_name']) && (mb_strlen($this->container['tpp_name']) < 0)) {
            $invalidProperties[] = "invalid value for 'tpp_name', the character length must be bigger than or equal to 0.";
        }
    ...
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) > 256)) {
            throw new \InvalidArgumentException('invalid length for $label when calling TppCredentialsParams., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($label) < 0)) {
            throw new \InvalidArgumentException('invalid length for $label when calling TppCredentialsParams., must be bigger than or equal to 0.');
        }
    ...
    public function setTppClientId($tpp_client_id)
    {
        ...
        if ((mb_strlen($tpp_client_id) > 256)) {
            throw new \InvalidArgumentException('invalid length for $tpp_client_id when calling TppCredentialsParams., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($tpp_client_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $tpp_client_id when calling TppCredentialsParams., must be bigger than or equal to 0.');
        }
    ...
    public function setTppClientSecret($tpp_client_secret)
    {
        ...
        if ((mb_strlen($tpp_client_secret) > 256)) {
            throw new \InvalidArgumentException('invalid length for $tpp_client_secret when calling TppCredentialsParams., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($tpp_client_secret) < 0)) {
            throw new \InvalidArgumentException('invalid length for $tpp_client_secret when calling TppCredentialsParams., must be bigger than or equal to 0.');
        }
    ...
    public function setTppApiKey($tpp_api_key)
    {
        ...
        if ((mb_strlen($tpp_api_key) > 256)) {
            throw new \InvalidArgumentException('invalid length for $tpp_api_key when calling TppCredentialsParams., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($tpp_api_key) < 0)) {
            throw new \InvalidArgumentException('invalid length for $tpp_api_key when calling TppCredentialsParams., must be bigger than or equal to 0.');
        }
    ...
    public function setTppName($tpp_name)
    {
        ...
        if ((mb_strlen($tpp_name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $tpp_name when calling TppCredentialsParams., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($tpp_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $tpp_name when calling TppCredentialsParams., must be bigger than or equal to 0.');
        }
