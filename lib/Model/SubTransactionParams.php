 ...
 */
class SubTransactionParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubTransactionParams';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['counterpart_account_number']) && (mb_strlen($this->container['counterpart_account_number']) < 1)) {
            $invalidProperties[] = "invalid value for 'counterpart_account_number', the character length must be bigger than or equal to 1.";
        }
     ...
     * Sets category_id
     *
     * @param int|null $category_id Category identifier. If not specified, the original transaction's category will be applied. If you explicitly want the sub-transaction to have no category, then pass this field with value '0' (zero).
     *
     * @return self
     */
     ...
     * Sets purpose
     *
     * @param string|null $purpose Purpose. If not specified, the original transaction's value will be applied.
     *
     * @return self
     */
    public function setPurpose($purpose)
    {
        ...
        if ((mb_strlen($purpose) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $purpose when calling SubTransactionParams., must be smaller than or equal to 2000.');
        }
        if ((mb_strlen($purpose) < 1)) {
            throw new \InvalidArgumentException('invalid length for $purpose when calling SubTransactionParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/[A-Za-z0-9¡-ʯ &\\(\\)\\{\\}\\[\\]\\.:,;\\?!\\+\\-_\\$@#~`\\^€]*/", $purpose))) {
     ...
     * Sets counterpart
     *
     * @param string|null $counterpart Counterpart. If not specified, the original transaction's value will be applied.
     *
     * @return self
     */
    public function setCounterpart($counterpart)
    {
        ...
        if ((mb_strlen($counterpart) > 80)) {
            throw new \InvalidArgumentException('invalid length for $counterpart when calling SubTransactionParams., must be smaller than or equal to 80.');
        }
        if ((mb_strlen($counterpart) < 1)) {
            throw new \InvalidArgumentException('invalid length for $counterpart when calling SubTransactionParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/[A-Za-z0-9¡-ʯ &\\(\\)\\{\\}\\[\\]\\.:,;\\?!\\+\\-_\\$@#~`\\^€]*/", $counterpart))) {
     ...
     *
     * @param string|null $counterpart_account_number Counterpart account number. If not specified, the original transaction's value will be applied.
     *
     * @return self
     */
    public function setCounterpartAccountNumber($counterpart_account_number)
    {
        ...
        if ((mb_strlen($counterpart_account_number) > 34)) {
            throw new \InvalidArgumentException('invalid length for $counterpart_account_number when calling SubTransactionParams., must be smaller than or equal to 34.');
        }
        if ((mb_strlen($counterpart_account_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $counterpart_account_number when calling SubTransactionParams., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/[A-Za-z0-9¡-ʯ &\\(\\)\\{\\}\\[\\]\\.:,;\\?!\\+\\-_\\$@#~`\\^€]*/", $counterpart_account_number))) {
     ...
     *
     * @param string|null $counterpart_iban Counterpart IBAN. If not specified, the original transaction's value will be applied.
     *
     * @return self
     */
     ...
     *
     * @param string|null $counterpart_bic Counterpart BIC. If not specified, the original transaction's value will be applied.
     *
     * @return self
     */
     ...
     *
     * @param string|null $counterpart_blz Counterpart BLZ. If not specified, the original transaction's value will be applied.
     *
     * @return self
     */
     ...
     * Sets label_ids
     *
     * @param int[]|null $label_ids List of connected labels. Note that when this field is not specified, then the labels of the original transaction will NOT get applied to the sub-transaction. Instead, the sub-transaction will have no labels assigned to it.
     *
     * @return self
     */
