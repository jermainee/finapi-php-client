 ...
 */
class CreateDirectDebitParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateDirectDebitParams';
    ...
    protected static $openAPITypes = [
        'single_booking' => 'bool',
        'account_id' => 'int',
        'direct_debit_type' => '\OpenAPI\Client\Model\DirectDebitType',
        'sequence_type' => '\OpenAPI\Client\Model\DirectDebitSequenceType',
        'direct_debits' => '\OpenAPI\Client\Model\DirectDebitOrderParams[]',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['direct_debits']) > 15000)) {
            $invalidProperties[] = "invalid value for 'direct_debits', number of items must be less than or equal to 15000.";
        }

        if ((count($this->container['direct_debits']) < 1)) {
            $invalidProperties[] = "invalid value for 'direct_debits', number of items must be greater than or equal to 1.";
        }
     ...
     *
     * @return \OpenAPI\Client\Model\DirectDebitType
     */
     ...
     *
     * @param \OpenAPI\Client\Model\DirectDebitType $direct_debit_type direct_debit_type
     *
     * @return self
     */
     ...
     * Gets sequence_type
     *
     * @return \OpenAPI\Client\Model\DirectDebitSequenceType
     */
     ...
     * Sets sequence_type
     *
     * @param \OpenAPI\Client\Model\DirectDebitSequenceType $sequence_type sequence_type
     *
     * @return self
     */
     ...
     * Gets direct_debits
     *
     * @return \OpenAPI\Client\Model\DirectDebitOrderParams[]
     */
     ...
     * Sets direct_debits
     *
     * @param \OpenAPI\Client\Model\DirectDebitOrderParams[] $direct_debits List of direct debit orders (may contain at most 15000 items). Please note that collective direct debit may not always be supported.<br/> <strong>Type:</strong> DirectDebitOrderParams
     *
     * @return self
     */
    public function setDirectDebits($direct_debits)
    {
        ...
        if ((count($direct_debits) > 15000)) {
            throw new \InvalidArgumentException('invalid value for $direct_debits when calling CreateDirectDebitParams., number of items must be less than or equal to 15000.');
        }
        if ((count($direct_debits) < 1)) {
            throw new \InvalidArgumentException('invalid length for $direct_debits when calling CreateDirectDebitParams., number of items must be greater than or equal to 1.');
        }
     ...
     * Sets execution_date
     *
     * @param \DateTime $execution_date <strong>Format:</strong> 'YYYY-MM-DD'<br/>Execution date for the direct debit(s). May not be in the past.
     *
     * @return self
     */
