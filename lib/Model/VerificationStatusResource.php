...
/**
 * VerificationStatusResource Class Doc Comment
 *
 * @category Class
 ...
 */
class VerificationStatusResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VerificationStatusResource';
    ...
    protected static $setters = [
        'user_id' => 'setUserId',
        'is_user_verified' => 'setIsUserVerified'
    ];
    ...
    protected static $getters = [
        'user_id' => 'getUserId',
        'is_user_verified' => 'getIsUserVerified'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_user_verified', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_user_verified'] === null) {
            $invalidProperties[] = "'is_user_verified' can't be null";
        }
    ...
    /**
     * Gets is_user_verified
     *
     * @return bool
     */
    public function getIsUserVerified()
    {
        return $this->container['is_user_verified'];
    }

    /**
     * Sets is_user_verified
     *
     * @param bool $is_user_verified User's verification status
     *
     * @return self
     */
    public function setIsUserVerified($is_user_verified)
    {
        if (is_null($is_user_verified)) {
            throw new \InvalidArgumentException('non-nullable is_user_verified cannot be null');
        }
        $this->container['is_user_verified'] = $is_user_verified;
