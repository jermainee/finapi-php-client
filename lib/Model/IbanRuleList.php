...
/**
 * IbanRuleList Class Doc Comment
 *
 * @category Class
 ...
 */
class IbanRuleList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IbanRuleList';
    ...
    */
     ...
     * Sets iban_rules
     *
     * @param \OpenAPI\Client\Model\IbanRule[] $iban_rules List of IBAN rules<br/> <strong>Type:</strong> IbanRule
     *
     * @return self
     */
