...
class Paging implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setPage($page)
    {
        ...
        if (($page < 1)) {
            throw new \InvalidArgumentException('invalid value for $page when calling Paging., must be bigger than or equal to 1.');
        }
    ...
    public function setPerPage($per_page)
    {
        ...
        if (($per_page < 1)) {
            throw new \InvalidArgumentException('invalid value for $per_page when calling Paging., must be bigger than or equal to 1.');
        }
    ...
    public function setPageCount($page_count)
    {
        ...
        if (($page_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $page_count when calling Paging., must be bigger than or equal to 0.');
        }
    ...
    public function setTotalCount($total_count)
    {
        ...
        if (($total_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_count when calling Paging., must be bigger than or equal to 0.');
        }
