 ...
 */
class UserUpdateParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_auto_update_enabled', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets email
     *
     * @param string|null $email User's new email address. Pass an empty string (\"\") if you want to clear the current email address.
     *
     * @return self
     */
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 320)) {
            throw new \InvalidArgumentException('invalid length for $email when calling UserUpdateParams., must be smaller than or equal to 320.');
        }
        if ((mb_strlen($email) < 0)) {
            throw new \InvalidArgumentException('invalid length for $email when calling UserUpdateParams., must be bigger than or equal to 0.');
        }
     ...
     * Sets phone
     *
     * @param string|null $phone User's new phone number. Pass an empty string (\"\") if you want to clear the current phone number.
     *
     * @return self
     */
    public function setPhone($phone)
    {
        ...
        if ((mb_strlen($phone) > 50)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling UserUpdateParams., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($phone) < 0)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling UserUpdateParams., must be bigger than or equal to 0.');
        }
