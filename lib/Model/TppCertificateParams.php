 ...
 */
class TppCertificateParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TppCertificateParams';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('ca_public_key', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['public_key']) > 10000)) {
            $invalidProperties[] = "invalid value for 'public_key', the character length must be smaller than or equal to 10000.";
        }
        ...
        if ((mb_strlen($this->container['private_key']) > 10000)) {
            $invalidProperties[] = "invalid value for 'private_key', the character length must be smaller than or equal to 10000.";
        }
        ...
        if (!is_null($this->container['passphrase']) && (mb_strlen($this->container['passphrase']) > 256)) {
            $invalidProperties[] = "invalid value for 'passphrase', the character length must be smaller than or equal to 256.";
        }
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Model\TppCertificateType
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Model\TppCertificateType $type type
     *
     * @return self
     */
    ...
    public function setPublicKey($public_key)
    {
        ...
        if ((mb_strlen($public_key) > 10000)) {
            throw new \InvalidArgumentException('invalid length for $public_key when calling TppCertificateParams., must be smaller than or equal to 10000.');
        }
        if ((mb_strlen($public_key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $public_key when calling TppCertificateParams., must be bigger than or equal to 1.');
        }
    ...
    public function setPrivateKey($private_key)
    {
        ...
        if ((mb_strlen($private_key) > 10000)) {
            throw new \InvalidArgumentException('invalid length for $private_key when calling TppCertificateParams., must be smaller than or equal to 10000.');
        }
        if ((mb_strlen($private_key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $private_key when calling TppCertificateParams., must be bigger than or equal to 1.');
        }
    ...
    public function setPassphrase($passphrase)
    {
        ...
        if ((mb_strlen($passphrase) > 256)) {
            throw new \InvalidArgumentException('invalid length for $passphrase when calling TppCertificateParams., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($passphrase) < 0)) {
            throw new \InvalidArgumentException('invalid length for $passphrase when calling TppCertificateParams., must be bigger than or equal to 0.');
        }
     ...
     * @return string|null
     */
    public function getCaPublicKey()
    {
        return $this->container['ca_public_key'];
    }

    /**
     * Sets ca_public_key
     *
     * @param string|null $ca_public_key A certificate (public key) of the certificate authority (CA) that signed the certificate. Required in certain cases to build the PKI path between Access and the bank's API when banks do not possess intermediate TLS certificates while placing the trust chain.
     *
     * @return self
     */
    public function setCaPublicKey($ca_public_key)
    {
        if (is_null($ca_public_key)) {
            throw new \InvalidArgumentException('non-nullable ca_public_key cannot be null');
        }
        $this->container['ca_public_key'] = $ca_public_key;
     ...
     * Sets label
     *
     * @param string $label A label for the certificate
     *
     * @return self
     */
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) > 256)) {
            throw new \InvalidArgumentException('invalid length for $label when calling TppCertificateParams., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($label) < 1)) {
            throw new \InvalidArgumentException('invalid length for $label when calling TppCertificateParams., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param \DateTime|null $valid_from_date <strong>Format:</strong> 'YYYY-MM-DD'<br/>Start day of the certificate's validity. Default is the passed certificate validFrom date
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $valid_until_date <strong>Format:</strong> 'YYYY-MM-DD'<br/>Expiration day of the certificate's validity. Default is the passed certificate validUntil date
     *
     * @return self
     */
