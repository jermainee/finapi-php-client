 ...
 */
class ExecutePasswordChangeParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExecutePasswordChangeParams';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('password_change_token', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['user_id']) > 36)) {
            $invalidProperties[] = "invalid value for 'user_id', the character length must be smaller than or equal to 36.";
        }
        ...
        if ((mb_strlen($this->container['password_change_token']) > 36)) {
            $invalidProperties[] = "invalid value for 'password_change_token', the character length must be smaller than or equal to 36.";
        }

        if ((mb_strlen($this->container['password_change_token']) < 36)) {
            $invalidProperties[] = "invalid value for 'password_change_token', the character length must be bigger than or equal to 36.";
        }
    ...
    public function setUserId($user_id)
    {
        ...
        if ((mb_strlen($user_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $user_id when calling ExecutePasswordChangeParams., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($user_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $user_id when calling ExecutePasswordChangeParams., must be bigger than or equal to 1.');
        }
    ...
    public function setPassword($password)
    {
        ...
        if ((mb_strlen($password) > 128)) {
            throw new \InvalidArgumentException('invalid length for $password when calling ExecutePasswordChangeParams., must be smaller than or equal to 128.');
        }
        if ((mb_strlen($password) < 6)) {
            throw new \InvalidArgumentException('invalid length for $password when calling ExecutePasswordChangeParams., must be bigger than or equal to 6.');
        }
    ...
    {
        if (is_null($password_change_token)) {
            throw new \InvalidArgumentException('non-nullable password_change_token cannot be null');
        }
        if ((mb_strlen($password_change_token) > 36)) {
            throw new \InvalidArgumentException('invalid length for $password_change_token when calling ExecutePasswordChangeParams., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($password_change_token) < 36)) {
            throw new \InvalidArgumentException('invalid length for $password_change_token when calling ExecutePasswordChangeParams., must be bigger than or equal to 36.');
        }
