 ...
 */
class TppCertificate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TppCertificate';
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'certificate_type' => '\OpenAPI\Client\Model\TppCertificateType',
        'label' => 'string',
        'valid_from' => '\DateTime',
    ...
    */
     ...
     *
     * @param \OpenAPI\Client\Model\TppCertificateType $certificate_type certificate_type
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string $label Label of certificate.
     *
     * @return self
     */
     ...
     * Sets valid_from
     *
     * @param \DateTime $valid_from <strong>Format:</strong> 'YYYY-MM-DD'<br/>Valid from date.
     *
     * @return self
     */
     ...
     * Sets valid_until
     *
     * @param \DateTime $valid_until <strong>Format:</strong> 'YYYY-MM-DD'<br/>Valid until date.
     *
     * @return self
     */
