...
class Product
{
    ...
    public const DATA_INTELLIGENCE = 'DATA_INTELLIGENCE';

    public const WEB_FORM = 'WEB_FORM';

    public const GIRO_IDENT = 'GIRO_IDENT';

    public const SCHUFA_API = 'SCHUFA_API';

    public const DI_LABELLING = 'DI_LABELLING';

    public const CONTRACT_MANAGER = 'CONTRACT_MANAGER';

    public const GIROCHECK = 'GIROCHECK';

    public const KREDITCHECK = 'KREDITCHECK';

    public const KREDITCHECK_B2_B = 'KREDITCHECK_B2B';

    public const DEBITFLEX = 'DEBITFLEX';

    public const TRANSPARENCY_REGISTER = 'TRANSPARENCY_REGISTER';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::GIROCHECK,
            self::KREDITCHECK,
            self::KREDITCHECK_B2_B,
            self::DEBITFLEX,
            self::TRANSPARENCY_REGISTER
        ];
    }
}
