 ...
 */
class EditBankConnectionParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EditBankConnectionParams';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['name']) && !preg_match("/[A-Za-z0-9¡-ʯ &\\(\\)\\{\\}\\[\\]\\.:,;\\?!\\+\\-_\\$@#~`\\^€]*/", $this->container['name'])) {
            $invalidProperties[] = "invalid value for 'name', must be conform to the pattern /[A-Za-z0-9¡-ʯ &\\(\\)\\{\\}\\[\\]\\.:,;\\?!\\+\\-_\\$@#~`\\^€]*/.";
        }

        if (!is_null($this->container['default_two_step_procedure_id']) && (mb_strlen($this->container['default_two_step_procedure_id']) > 512)) {
            $invalidProperties[] = "invalid value for 'default_two_step_procedure_id', the character length must be smaller than or equal to 512.";
        }

        if (!is_null($this->container['default_two_step_procedure_id']) && (mb_strlen($this->container['default_two_step_procedure_id']) < 0)) {
            $invalidProperties[] = "invalid value for 'default_two_step_procedure_id', the character length must be bigger than or equal to 0.";
        }
     ...
     * Sets name
     *
     * @param string|null $name New name for the bank connection. If you do not want to change the current name let this field remain unset. If you want to clear the current name, set the field's value to an empty string (\"\").<br/><br/><strong>NOTE:</strong> If you are a Web Form 2.0 customer, and would like to update the name of your bank connection, please use the API parameter.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling EditBankConnectionParams., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling EditBankConnectionParams., must be bigger than or equal to 0.');
        }
        if ((!preg_match("/[A-Za-z0-9¡-ʯ &\\(\\)\\{\\}\\[\\]\\.:,;\\?!\\+\\-_\\$@#~`\\^€]*/", $name))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling EditBankConnectionParams., must conform to the pattern /[A-Za-z0-9¡-ʯ &\\(\\)\\{\\}\\[\\]\\.:,;\\?!\\+\\-_\\$@#~`\\^€]*/.");
        }
     ...
     *
     * @param \OpenAPI\Client\Model\BankingInterface|null $banking_interface banking_interface
     *
     * @return self
     */
    ...
    public function setDefaultTwoStepProcedureId($default_two_step_procedure_id)
    {
        ...
        if ((mb_strlen($default_two_step_procedure_id) > 512)) {
            throw new \InvalidArgumentException('invalid length for $default_two_step_procedure_id when calling EditBankConnectionParams., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($default_two_step_procedure_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $default_two_step_procedure_id when calling EditBankConnectionParams., must be bigger than or equal to 0.');
        }
