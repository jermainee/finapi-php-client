...
class ClientConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'mandator_license' => '\OpenAPI\Client\Model\MandatorLicense',
        'preferred_consent_type' => '\OpenAPI\Client\Model\PreferredConsentType',
        ...
        'products' => 'Product[]',
        'enabled_products' => '\OpenAPI\Client\Model\EnabledProducts',
        ...
        'category_restrictions' => '\OpenAPI\Client\Model\Category[]',
    ...
    protected static $setters = [
        ...
        'enabled_products' => 'setEnabledProducts',
    ...
    protected static $getters = [
        ...
        'enabled_products' => 'getEnabledProducts',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('ais_enabled', $data ?? [], null);
        ...
        $this->setIfExists('enabled_products', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ais_enabled'] === null) {
            $invalidProperties[] = "'ais_enabled' can't be null";
        }
        ...
        if ($this->container['enabled_products'] === null) {
            $invalidProperties[] = "'enabled_products' can't be null";
        }
     ...
     *
     * @return \OpenAPI\Client\Model\MandatorLicense
     */
     ...
     *
     * @param \OpenAPI\Client\Model\MandatorLicense $mandator_license mandator_license
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\PreferredConsentType
     */
     ...
     *
     * @param \OpenAPI\Client\Model\PreferredConsentType $preferred_consent_type preferred_consent_type
     *
     * @return self
     */
     ...
     * @return bool
     */
    public function getAisEnabled()
    {
        return $this->container['ais_enabled'];
    }

    /**
     * Sets ais_enabled
     *
     * @param bool $ais_enabled Whether this client is allowed to do AIS (Account Information Services). This setting must be enabled for doing bank connection imports or updates (including finAPI's automatic batch updates), or calling other AIS endpoints that relate to bank connections, accounts, or transactions/security positions.
     *
     * @return self
     */
    public function setAisEnabled($ais_enabled)
    {
        if (is_null($ais_enabled)) {
            throw new \InvalidArgumentException('non-nullable ais_enabled cannot be null');
        }
        $this->container['ais_enabled'] = $ais_enabled;
     ...
     * Sets products
     *
     * @param Product[] $products THIS FIELD IS DEPRECATED AND WILL BE REMOVED.<br/>Please refer to the 'enabledProducts' field instead.<br/><br/>List of finAPI products that are available to this client. Newly added products won't be represented within this field, but only in the new 'enabledProducts' field.<br/> <strong>Type:</strong> Product
     *
     * @return self
     */
    ...
    /**
     * Gets enabled_products
     *
     * @return \OpenAPI\Client\Model\EnabledProducts
     */
    public function getEnabledProducts()
    {
        return $this->container['enabled_products'];
    }

    /**
     * Sets enabled_products
     *
     * @param \OpenAPI\Client\Model\EnabledProducts $enabled_products enabled_products
     *
     * @return self
     */
    public function setEnabledProducts($enabled_products)
    {
        if (is_null($enabled_products)) {
            throw new \InvalidArgumentException('non-nullable enabled_products cannot be null');
        }
        $this->container['enabled_products'] = $enabled_products;
     ...
     *
     * @param bool $ais_via_web_form Whether you must use finAPI's Web Form for Account Information Services. See: https://documentation.finapi.io/webform
     *
     * @return self
     */
     ...
     *
     * @param bool $pis_via_web_form Whether you must use finAPI's Web Form for Standard Payment Initiation Services (Payments for accounts that have been imported in finAPI). See: https://documentation.finapi.io/webform
     *
     * @return self
     */
     ...
     *
     * @param bool $pis_standalone_via_web_form Whether you must use finAPI's Web Form for Standalone Payment Initiation Services (Payments without account import). See: https://documentation.finapi.io/webform
     *
     * @return self
     */
