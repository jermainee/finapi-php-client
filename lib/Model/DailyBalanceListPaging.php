...
/**
 * DailyBalanceListPaging Class Doc Comment
 *
 * @category Class
 * @description Information for pagination&lt;br/&gt; &lt;strong&gt;Type:&lt;/strong&gt; Paging
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DailyBalanceListPaging implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DailyBalanceList_paging';
    ...
    */
    ...
    public function setPage($page)
    {
        ...
        if (($page < 1)) {
            throw new \InvalidArgumentException('invalid value for $page when calling DailyBalanceListPaging., must be bigger than or equal to 1.');
        }
    ...
    public function setPerPage($per_page)
    {
        ...
        if (($per_page < 1)) {
            throw new \InvalidArgumentException('invalid value for $per_page when calling DailyBalanceListPaging., must be bigger than or equal to 1.');
        }
    ...
    public function setPageCount($page_count)
    {
        ...
        if (($page_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $page_count when calling DailyBalanceListPaging., must be bigger than or equal to 0.');
        }
    ...
    public function setTotalCount($total_count)
    {
        ...
        if (($total_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_count when calling DailyBalanceListPaging., must be bigger than or equal to 0.');
        }
