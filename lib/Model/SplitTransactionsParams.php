...
/**
 * SplitTransactionsParams Class Doc Comment
 *
 * @category Class
 ...
 */
class SplitTransactionsParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SplitTransactionsParams';
    ...
    protected static $openAPITypes = [
        'sub_transactions' => '\OpenAPI\Client\Model\SubTransactionParams[]'
    ];
    ...
    {
        $this->setIfExists('sub_transactions', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sub_transactions'] === null) {
            $invalidProperties[] = "'sub_transactions' can't be null";
        }
     ...
     *
     * @return \OpenAPI\Client\Model\SubTransactionParams[]
     */
     ...
     *
     * @param \OpenAPI\Client\Model\SubTransactionParams[] $sub_transactions List of sub-transactions<br/> <strong>Type:</strong> SubTransactionParams
     *
     * @return self
     */
    public function setSubTransactions($sub_transactions)
    {
        if (is_null($sub_transactions)) {
            throw new \InvalidArgumentException('non-nullable sub_transactions cannot be null');
        }
