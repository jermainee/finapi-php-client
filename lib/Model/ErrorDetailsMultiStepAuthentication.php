 ...
 *
 * @category Class
 * @description This field is set when a multi-step authentication is required, i.e. when you need to repeat the original service call and provide additional data. The field contains information about what additional data is required.&lt;br/&gt; &lt;strong&gt;Type:&lt;/strong&gt; MultiStepAuthenticationChallenge
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class ErrorDetailsMultiStepAuthentication implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Model\MsaStatus
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\MsaStatus $status status
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\TwoStepProcedure[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\TwoStepProcedure[]|null $two_step_procedures In case of status = TWO_STEP_PROCEDURE_REQUIRED, this field contains the available two-step procedures. Note that this set does not necessarily match the set that is stored in the respective bank connection interface. You should always use the set from this field for the multi-step authentication flow.<br/> <strong>Type:</strong> TwoStepProcedure
     *
     * @return self
     */
