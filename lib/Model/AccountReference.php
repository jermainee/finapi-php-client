...
class AccountReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['iban']) > 88)) {
            $invalidProperties[] = "invalid value for 'iban', the character length must be smaller than or equal to 88.";
        }
     ...
     * Sets iban
     *
     * @param string $iban The account's IBAN
     *
     * @return self
     */
    public function setIban($iban)
    {
        ...
        if ((mb_strlen($iban) > 88)) {
            throw new \InvalidArgumentException('invalid length for $iban when calling AccountReference., must be smaller than or equal to 88.');
        }
        if ((mb_strlen($iban) < 1)) {
            throw new \InvalidArgumentException('invalid length for $iban when calling AccountReference., must be bigger than or equal to 1.');
        }
