...
/**
 * SwitchApiVersionParams Class Doc Comment
 *
 * @category Class
 ...
 */
class SwitchApiVersionParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SwitchApiVersionParams';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['api_version']) > 4)) {
            $invalidProperties[] = "invalid value for 'api_version', the character length must be smaller than or equal to 4.";
        }

        if ((mb_strlen($this->container['api_version']) < 1)) {
            $invalidProperties[] = "invalid value for 'api_version', the character length must be bigger than or equal to 1.";
        }
     ...
     * Sets api_version
     *
     * @param string $api_version The target API version to which you want to migrate your client.<br/><br/>Possible values: <code>V1</code>,<code>V2</code>
     *
     * @return self
     */
    public function setApiVersion($api_version)
    {
        ...
        if ((mb_strlen($api_version) > 4)) {
            throw new \InvalidArgumentException('invalid length for $api_version when calling SwitchApiVersionParams., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($api_version) < 1)) {
            throw new \InvalidArgumentException('invalid length for $api_version when calling SwitchApiVersionParams., must be bigger than or equal to 1.');
        }
