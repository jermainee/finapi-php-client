...
class Transaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'primanota' => 'string',
        'category' => '\OpenAPI\Client\Model\TransactionCategory',
    ...
    */
     ...
     * Sets category
     *
     * @param \OpenAPI\Client\Model\TransactionCategory|null $category category
     *
     * @return self
     */
     ...
     * Sets labels
     *
     * @param \OpenAPI\Client\Model\Label[] $labels Array of assigned labels<br/> <strong>Type:</strong> Label
     *
     * @return self
     */
