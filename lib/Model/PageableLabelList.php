...
/**
 * PageableLabelList Class Doc Comment
 *
 * @category Class
 ...
 */
class PageableLabelList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PageableLabelList';
    ...
    */
     ...
     * Sets labels
     *
     * @param \OpenAPI\Client\Model\Label[] $labels Labels<br/> <strong>Type:</strong> Label
     *
     * @return self
     */
