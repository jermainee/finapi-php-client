# OpenAPI\Client\ClientConfigurationApi

All URIs are relative to https://sandbox.finapi.io, except if the operation defines another base path.

| Method | HTTP request | Description |
| ------------- | ------------- | ------------- |
| [**editClientConfiguration()**](ClientConfigurationApi.md#editClientConfiguration) | **PATCH** /api/v2/clientConfiguration | Edit client configuration |
| [**getClientConfiguration()**](ClientConfigurationApi.md#getClientConfiguration) | **GET** /api/v2/clientConfiguration | Get client configuration |


## `editClientConfiguration()`

```php
editClientConfiguration($client_configuration_params, $x_http_method_override, $x_request_id): \OpenAPI\Client\Model\ClientConfiguration
```
...
$apiInstance = new OpenAPI\Client\Api\ClientConfigurationApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$client_configuration_params = new \OpenAPI\Client\Model\ClientConfigurationParams(); // \OpenAPI\Client\Model\ClientConfigurationParams | Client configuration parameters
...
| ------------- | ------------- | ------------- | ------------- |
| **client_configuration_params** | [**\OpenAPI\Client\Model\ClientConfigurationParams**](../Model/ClientConfigurationParams.md)| Client configuration parameters | |
...
[**\OpenAPI\Client\Model\ClientConfiguration**](../Model/ClientConfiguration.md)
...
```php
getClientConfiguration($x_request_id): \OpenAPI\Client\Model\ClientConfiguration
```
